...
class Program
{
    ...
    private const string ApiKey = "50113b4ed6b2191f58449850655c7267"; // API ключ для доступа к OpenWeather API
    ...
    private static async Task<Weather?> GetWeatherData(string url)
    {
        try
        {
            ...
            {
                Console.WriteLine("Нет такой страны :("); // Логирование проблемы с данными
            }
        }
